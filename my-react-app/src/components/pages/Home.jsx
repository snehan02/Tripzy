    ...
    <>
      ...
      <section className="features-section">
        ...
        <div className="features-container">
          <div className="feature-card">
            ...
            <p>
              Explore handpicked destinations across the world with
          ...
          <div className="feature-card">
            ...
            <p>
              Enjoy premium hotels and accommodations carefully selected for
              every traveler.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>
              Travel more while spending less with our budget-friendly tour
              packages.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <h3>Safe Travel</h3>
            <p>
              Your safety is our priority with trusted guides and secure travel
              planning.
            </p>
          </div>
        </div>
      ...
      <section className="testimonials-section">
        ...
        <div className="testimonial-cards">
          <div className="testimonial-card">
            <p>
              "Tripzy made our honeymoon unforgettable. Everything was perfectly
              planned."
            </p>
            <h4>— Sarah Johnson</h4>
          </div>
      ...
      <section className="subscribe-section">
        <div className="subscribe-content">
          ...
          <p>
            Get exclusive offers, travel tips, and exciting destination updates
      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-col">
            ...
            <p>
              Explore the world with Tripzy. We create memorable travel
              experiences, exciting adventures, and stress-free vacations.
            </p>
          </div>
